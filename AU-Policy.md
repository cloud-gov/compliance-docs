...
The Cloud Operations team acts on findings that result from its regular audit process according to its incident response guidelines (https://cloud.gov/docs/ops/security-ir/), including notifying GSA Information Security, the System Owner, and the ISSO.
