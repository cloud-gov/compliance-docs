...
cloud.gov's customers gain access to the system in a similar fashion. UAA Servers can integrate with any enterprise identity system that supports the Security Assertion Markup Language (SAML) standard. Cloud Operations and the customer follow a simple procedure (https://docs.cloud.gov/ops/federated-identity/) in order to complete the integration.
